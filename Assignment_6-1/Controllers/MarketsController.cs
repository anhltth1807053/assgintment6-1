...
namespace Assignment_6_1.Controllers
{
    public class MarketsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "marketId,name,description,createdAt,deletedAt,status")] Market market)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "marketId,name,description,createdAt,deleteddAt,status")] Market market)
        {
            if (ModelState.IsValid)
            {
